...
def get_args_parser():
    ...
    parser.add_argument('--root_path', default='/data/hico', type=str)
    parser.add_argument('--train_path', default='/data/hico/images/train2015', type=str)
    parser.add_argument('--test_path', default='/data/hico/images/test2015', type=str)
    parser.add_argument('--train_anno_path', default='/data/hico/annotations/trainval_hico.json', type=str)
    parser.add_argument('--test_anno_path', default='/data/hico/annotations/test_hico.json', type=str)
    ...
    parser.add_argument('--with_encoder', action='store_true', help='')
    ...
    parser.add_argument('--without_decoder', action='store_true', default=False, help="do not use decoder")
    parser.add_argument('--interleave', action='store_true', default=False, help="interleave transformer encoder and decoder")
    ...
    parser.add_argument('--with_interaction_box_refine', default=False, type=lambda x: (str(x).lower() == 'true'), 
                        help='iterative box refinement for interaction region')
    parser.add_argument('--with_interaction_vector_refine', default=False, type=lambda x: (str(x).lower() == 'true'), 
                        help='iterative box refinement for interaction vector')
    ...
    ####### BG feature extraction
    parser.add_argument('--bg_token_num', default=None, type=int, help="Number of [BG] tokens in the body backbone")
    ...
    parser.add_argument('--activation', default='gelu', type=str, help="Activation function to use")
