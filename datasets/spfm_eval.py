...
class SPFMEvaluator():
    def __init__(self, preds, gts, args):
        self.correct_mat = np.load(os.path.join(args.root_path, "annotations", "corre_spfm.npy"))
        self.overlap_iou = 0.5
        self.max_hois = 100
        self.verb_name_dict = {0: 'hold'}
        self.fp = {}
        self.tp = {}
        self.score = {}
...
if __name__ == "__main__":
    ...
    class Args:
        def __init__(self):
            self.use_nms = False
            self.nms_thresh = 0.5
            self.root_path = os.path.join("data", "spfm")
            self.dataset_file = "spfm"
