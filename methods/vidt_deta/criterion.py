...
class SetCriterion(nn.Module):
    ...
    def __init__(self, num_classes, num_queries, matcher, weight_dict, losses, focal_alpha=0.25,
        ...
        self.stg1_assigner = Stage2Assigner(num_queries,positive_fraction=0.5,
                                            threshold=0.7)
        self.stg2_assigner = Stage2Assigner(num_queries,positive_fraction=0.25,
                                            threshold=0.6)
