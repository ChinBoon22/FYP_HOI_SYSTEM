...
OBJ_CLS_LOSS_COEF = 1       # Classification Loss for Object Labels
VERB_CLS_LOSS_COEF = 1      # Classification Loss for Verb Labels
BBOX_LOSS_COEF = 2.5        # Bounding box regression loss
GIOU_LOSS_COEF = 1          # Generalized IoU (Intersection over Union) loss
...
def weight_dict():
    return {
        ...
        'loss_obj_giou': GIOU_LOSS_COEF  # Object 
    }
...
def target_indices():
    """
    A list of index pairs used for matching targets with predictions
    """
